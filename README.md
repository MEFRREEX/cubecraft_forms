...
Title: ```is_dynamic&side_text<title>``` Buttons: ```grid_tile<button name>``` Header buttons: ```header_button§s§r<button name>```

![image](https://user-images.githubusercontent.com/83061703/202970775-5119837d-e7a3-408d-98c5-4c317bb5c952.png)
Title: ```is_dynamic&small_grid&grid_text<title>``` Rect buttons: ```rect_button<button name>``` Buttons: ```grid_tile<button name>``` 
